...
public class PropertyConfig {
	...
	Boolean showParsedResumeDetails = false;
	...
	String resumeParsingUrl = "http://68.183.92.250:9002/api/resume_analysis/";
	
	String defaultCompanyId = "AL";
	...
	public String getResumeParsingUrl() {
		return resumeParsingUrl;
	}

	public void setResumeParsingUrl(String resumeParsingUrl) {
		this.resumeParsingUrl = resumeParsingUrl;
	}

	public Boolean getShowParsedResumeDetails() {
		return showParsedResumeDetails;
	}

	public void setShowParsedResumeDetails(Boolean showParsedResumeDetails) {
		this.showParsedResumeDetails = showParsedResumeDetails;
	}
