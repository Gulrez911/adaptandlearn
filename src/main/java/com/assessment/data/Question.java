...
//	@Column(length=2000)
	...
	Integer weightExtremePositiveValue;
	
	Integer weightInvalidDataValue;
	
	Integer passPercentforCodingQAsPerWeightedScore;
	...
	String parentGroupClassifier;
	
	@Transient
	List<String> listparentGroupClassifier;
	
	
public List<String> getListparentGroupClassifier() {
		return listparentGroupClassifier;
	}
	public void setListparentGroupClassifier(List<String> listparentGroupClassifier) {
		this.listparentGroupClassifier = listparentGroupClassifier;
	}
public String getDisplayq1() {
		return displayq1;
	}
	public void setDisplayq1(String displayq1) {
		this.displayq1 = displayq1;
	}
	public String getParentGroupClassifier() {
		return parentGroupClassifier;
	}
	public void setParentGroupClassifier(String parentGroupClassifier) {
		this.parentGroupClassifier = parentGroupClassifier;
	}
	//	@Column(length=1000)
	@Column(columnDefinition = "TEXT")
	String mmlStackUrl;
	...
	public void setup() {
		if(getQuestionType().getType().equalsIgnoreCase(QuestionType.MCQ.getType())) {
			...
			if(getQuestionText() == null || getQuestionText().trim().length() == 0){
				throw new AssessmentGenericException("NO_QUESTION_TEXT");
			}
			
			if(getQualifier1() == null || getQualifier1().trim().length() == 0){
				throw new AssessmentGenericException("NO_QUALIFIER1_AVAILABLE");
			}
	...
	private String getTestCategoryURLForAdd() {
		String url = "<a id=\"addAllQId\"    href=\"";
		if(getQualifier1() != null && getQualifier1().trim().length() != 0) {
			if(getQualifier2() != null && getQualifier2().trim().length() != 0) {
				if(getQualifier3() != null && getQualifier3().trim().length() != 0) {
					if(getQualifier4() != null && getQualifier4().trim().length() != 0) {
	...
	private String getTestCategoryURLForRemove() {
		String url = "<a id=\"removeAllQId\" href=\"";
		if(getQualifier1() != null && getQualifier1().trim().length() != 0) {
			if(getQualifier2() != null && getQualifier2().trim().length() != 0) {
				if(getQualifier3() != null && getQualifier3().trim().length() != 0) {
					if(getQualifier4() != null && getQualifier4().trim().length() != 0) {
...
//		url = url.replace("$url", testCat);
	...
	public Integer getWeightInputPositive() {
		return weightInputPositive == null?1:weightInputPositive;
	}
	public void setWeightInputPositive(Integer weightInputPositive) {
		this.weightInputPositive = weightInputPositive;
	}
	public Integer getWeightInputNegative() {
		return weightInputNegative == null ? 1:weightInputNegative;
	}
	public void setWeightInputNegative(Integer weightInputNegative) {
		this.weightInputNegative = weightInputNegative;
	}
	public Integer getWeightExtremeMinimalValue() {
		return weightExtremeMinimalValue == null?1:weightExtremeMinimalValue;
	}
	public void setWeightExtremeMinimalValue(Integer weightExtremeMinimalValue) {
		this.weightExtremeMinimalValue = weightExtremeMinimalValue;
	}
	public Integer getWeightExtremePositiveValue() {
		return weightExtremePositiveValue == null?1:weightExtremePositiveValue;
	}
	public void setWeightExtremePositiveValue(Integer weightExtremePositiveValue) {
		this.weightExtremePositiveValue = weightExtremePositiveValue;
	}
	public Integer getWeightInvalidDataValue() {
		return weightInvalidDataValue == null?1:weightInvalidDataValue;
	}
	public void setWeightInvalidDataValue(Integer weightInvalidDataValue) {
		this.weightInvalidDataValue = weightInvalidDataValue;
	}
	
	/**
	 * Default pass threshold for Coding q is 60 % if not specified.
	 * @return
	 */
	public Integer getPassPercentforCodingQAsPerWeightedScore() {
		return passPercentforCodingQAsPerWeightedScore == null ? 50:this.passPercentforCodingQAsPerWeightedScore;
	}
	public void setPassPercentforCodingQAsPerWeightedScore(Integer passPercentforCodingQAsPerWeightedScore) {
		this.passPercentforCodingQAsPerWeightedScore = passPercentforCodingQAsPerWeightedScore;
	}
	public String getFullStackText() {
		return fullStackText;
	}
	public void setFullStackText(String fullStackText) {
		this.fullStackText = fullStackText;
	}
	...
	public Integer getNoOfChoices(){
		if(getChoice1() ==null || getChoice1().trim().length() == 0){
			return 0;
		}
		if(getChoice2() ==null || getChoice2().trim().length() == 0){
			return 1;
		}
		
		if(getChoice3() ==null || getChoice3().trim().length() == 0){
			return 2;
		}
		
		if(getChoice4() ==null || getChoice4().trim().length() == 0){
			return 3;
		}
		
		if(getChoice5() ==null || getChoice5().trim().length() == 0){
			return 4;
		}
		
		if(getChoice6() ==null || getChoice6().trim().length() == 0){
			return 5;
		}
	...
	public Boolean isMultiChoice(){
		if(getRightChoices() != null && getRightChoices().split("-").length > 1){
			return true;
		}
		else{
			return false;
	...
	public List<String> getAllChoices(){
		...
		if(getChoice1() != null && getChoice1().length() > 0){
			choices.add(getChoice1());
		}
		
		if(getChoice2() != null && getChoice2().length() > 0){
			choices.add(getChoice2());
		}
		
		if(getChoice3() != null && getChoice3().length() > 0){
			choices.add(getChoice3());
		}
		
		if(getChoice4() != null && getChoice4().length() > 0){
			choices.add(getChoice4());
		}
		
		if(getChoice5() != null && getChoice5().length() > 0){
			choices.add(getChoice5());
		}
		
		if(getChoice6() != null && getChoice6().length() > 0){
			choices.add(getChoice6());
		}
