...
public class QuestionInstanceDto {
	...
	String questionMarkedReviewText;
	...
	public String getQuestionMarkedReviewText() {
		return questionMarkedReviewText;
	}

	public void setQuestionMarkedReviewText(String questionMarkedReviewText) {
		this.questionMarkedReviewText = questionMarkedReviewText;
	}
