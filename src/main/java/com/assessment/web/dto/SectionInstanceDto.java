...
public class SectionInstanceDto {
	...
	Integer noAnswered = 0;
	
	Integer noSkippedOrNotAnswered;
	...
	public Integer getNoAnswered() {
		Integer answered = 0;
		for(QuestionInstanceDto dto : getQuestionInstanceDtos()){
			if(dto.getQuestionMapperInstance().getAnswered() != null && dto.getQuestionMapperInstance().getAnswered()){
				answered ++;
			}
		}
		return answered;
	...
	public Integer getNoSkippedOrNotAnswered() {
	...
	public void setNoSkippedOrNotAnswered(Integer noSkippedOrNotAnswered) {
		this.noSkippedOrNotAnswered = noSkippedOrNotAnswered;
	}
