...
<%--                                      <form name="linkForm"  method="post" modelAttribute="link" action="saveTestLink"> --%>
					...
					<div class="formfield">
							...
							<form:input path="link.edDate" class="form-control" required="true" />
													...
													<div class="option">
                                                        <label>Don't Check Time Validity </label>
														<div class='input-group date' id='dontCheckTimeValidity'>
							<form:checkbox path="link.dontCheckTimeValidity" /> 
													...
													<div class="option">
                                                        <label>Web Proctoring ON </label>
														<div class='input-group date' id='webProctored'>
