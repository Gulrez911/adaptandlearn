				...
				<div class="col-md-12 mb-4">
					<div class="question_bank_heading">
						<div class="result_heading">
							...
							<h3>Hey ${userTestSession.firstName} ${userTestSession.lastName}</h3>
							<p>
					...
					<div class="result_data_Sec">
						<div class="data">
							<div class="data_list">
								...
								<div class="data_text">
									<p>Total Questions</p>
									<h3>${userTestSession.totalMarks} Question</h3>
							...
							<div class="data_list">
								...
								<div class="data_text">
									<p>Status</p>
<%-- 									<h3>${userTestSession.pass == true? " Fail":"Success"}</h3> --%>
									<h3>${userTestSession.pass==false?"Fail":"Success"}</h3>
								</div>
							</div>
							<div class="data_list">
								<div class="data_icon">
								...
								<div class="data_text">
									<p>Your Score</p>
									<h3>${userTestSession.percentageMarksRecieved} %</h3>
									<!--                                     <p>Your Score</p> -->
									<!--                                     <h3>35%</h3> -->
								</div>
							</div>
	...
	var disp = '<h3>Test  - ${userTestSession.testName} ';
