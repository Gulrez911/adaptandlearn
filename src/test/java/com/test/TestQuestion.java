...
public class TestQuestion {
	...
	@Test
	@Rollback(value=false)
	public void testGetQByPK(){
		questionRepository.findByPrimaryKey("eee", "IH");
	}
	
	@Test
	@Rollback(value=false)
	public void testGetqByPKAndQual(){
		//2 tested
		//Question q = questionRepository.findByPrimaryKeyTillQualifier4("Which one of the following indicates end of string?", "IH", "NLP", "Natural Language Processing with Real World Projects", "Introduction to NLP and Regex", "Regular Expressions part three");
		//Question q = questionRepository.findByPrimaryKeyTillQualifier3("subjective 3", "IH", "General", "subjective", "");
		//Question q = questionRepository.findByPrimaryKeyTillQualifier1("Adaptive Q 5 - 1619072482089", "IH",  "Adaptive_Level5");
		Question q = questionRepository.findByPrimaryKeyAndAllQualifiers("Which of the following events occurred first?", "IH",  "Competitive Exams", "SSC", "CGL Exam", "2017", "Ancient History");		
...
//		System.out.println(count);
	...
	public void testGetCountqType(){
		String testname = "Java_FullStack_1";
		System.out.println(questionMapperRepository.findCountOfFullstackQsforTest(testname, "IH"));
	}
	
	@Test
	public void testGetQmapper(){
		QuestionMapper mapper = questionMapperRepository.findUniqueQuestionMapper("Section - Logical Reasoning", "Assessment - Logical Reasoning-Aptitude", 211l, "e-assess");
		System.out.println(mapper.getQuestion().getQuestionText());
	}
